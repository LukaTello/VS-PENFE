...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		switch (curStage)
		{
			...
			case 'penfeday':
				var penfedaybg:BGSprite = new BGSprite('squad/bg1', -700, -300, 0.9, 0.9);
				add(penfedaybg);
			case 'penfeafter':
				var penfeafterbg:BGSprite = new BGSprite('squad/bg2', -700, -300, 0.9, 0.9);
				add(penfeafterbg);
			case 'penfenight':
				var penfenightbg:BGSprite = new BGSprite('squad/bg3', -700, -300, 0.9, 0.9);
				add(penfenightbg);
			case 'penfedawn':
				var penfedawnbg:BGSprite = new BGSprite('squad/bg4', -700, -300, 0.9, 0.9);
				add(penfedawnbg);
		}
		...
		if (isStoryMode && !seenCutscene)
		{
			switch (daSong)
			{
				...
				case 'penfenator' | 'brawl' | 'tilted' | 'this-is-epic':
