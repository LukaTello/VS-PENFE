...
class CreditsState extends MusicBeatState
{
	...
	private static var creditsStuff:Array<Dynamic> = [ //Name - Icon name - Description - Link - BG Color
		['Penfe Mod'],
		['LukaTello',		'lukatello',		'Main Artist and Programmer of Penfe Mod',					'https://twitter.com/_lukatello_',	0xFFFFFFFF],
		['JazzielCat9',			'jazzielcat9',		'Composer of Penfe Mod',				'https://twitter.com/Jazziel23556970',		0xFF078F00],
		[''],
		['Psych Engine Team'],
